  ...
  const slides = [
    {
      ...
      description:
        "Experience the Open Sky With The Largest Panoramic Sunroof - Perfect for a More Open Feel And Cabin Experience.",
    },
    {
      image: slideb,
      title: "Modern Grille and Headlights",
      description:
        "Stand Out With a Bold Interior Smile And Sleek LED Headlights, Combined With Advanced Read Light Clusters.",
    },
    {
      image: slidec,
  ...
  const slides2 = [
    {
      ...
      description:
        "Step Into A Roomy, Two-Space Cabin Where Comfort And Innovation Come Together. Thoughtfully Designed For You, The Driver-Interior Offers Maximum Space And Even Smart Features Throughout Made From Ultra-Premium, Eco-Friendly Materials.",
    },
    {
      image: slideB,
      title: "ERGONOMIC SEATS WITH LEATHER & VENTILATION OPTION",
      description:
        "Designed For Optimal Comfort And Support, The Seats Feature High-End Finishes And Optional Ventilation To Enhance The Driving Experience In Modern Luxury.",
    },
    {
      image: slideC,
  ...
  const securitySlides = [
    {
      ...
      description:
        "ADAS Advanced Driver Assistance System Enhances Driver Safety With Intelligent Features Like Lane Departure Warning, Automatic Emergency Braking, And Smart Collision For A Smarter, More Secure Drive.",
    },
    {
      image: slideb,
      title: "AEB Autonomous Emergency Braking",
      description:
        "A Autonomous Emergency Braking And Automatic Pre-The The Brakes If It Helps Find A Potential Collision, Significantly Reducing The Impact Of Automatic The Risk Of Accidents For Your Safety.",
    },
    {
      image: slidec,
      title: "Lane Departure Warning System",
      description:
        "Advanced lane monitoring technology that alerts drivers when unintentional lane departures are detected, ensuring safer highway driving.",
    },
    {
      image: slided,
      title: "Collision Avoidance Technology",
      description:
        "State-of-the-art sensors and AI technology work together to predict and prevent potential collisions before they occur.",
    },
  ];
              ...
              <div
                ...
                style={{
                  transform: `translateX(-${
                    currentSlideIndex * (window.innerWidth < 768 ? 100 : 50)
                  }%)`,
                }}
              >
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden">
              <div
                ...
                style={{
                  transform: `translateX(-${
                    currentSlideIndex2 * (window.innerWidth < 768 ? 100 : 50)
                  }%)`,
                }}
              >
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden">
              <div
                ...
                style={{
                  transform: `translateX(-${
                    currentSlideIndex3 * (window.innerWidth < 768 ? 100 : 50)
                  }%)`,
                }}
              >
