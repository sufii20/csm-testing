          ...
          <div className="p-8">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between mb-8">
              <div className="lg:w-1/2 mb-6 lg:mb-0">
                <h2 className="text-xl text-gray-700 mb-6">BYD Atto 3 - Advance</h2>
          ...
          <div className="border-t border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between py-4 border-b border-gray-100">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-800 font-semibold">8,990,000 PKR</span>
                </div>
              </div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex justify-between py-2 border-b border-gray-200 pb-4">
                ...
                <span className="text-gray-800 font-semibold">1,750,000 PKR</span>
              </div>
            </div>
